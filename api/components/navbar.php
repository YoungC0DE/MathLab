...
<nav class="navbar navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <div class="d-flex flex-row gap-4 navbar-nav">
            ...
            <a class="nav-link active" aria-current="page" href="?page=bhaskara">Equação 2º grau</a>
            <a class="nav-link active" aria-current="page" href="?page=bhaskara">Fibonacci</a>
            <a class="nav-link active" aria-current="page" href="?page=bhaskara">MMC</a>
        </div>
